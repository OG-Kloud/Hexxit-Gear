...
public class TribalArmor extends ItemArmorBase{

	public TribalArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String name) {
