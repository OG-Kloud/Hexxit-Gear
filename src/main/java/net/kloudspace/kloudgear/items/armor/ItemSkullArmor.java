...
//	}
   ...
   // @Override
    ...
    if (player.getCurrentArmor(1) != null && player.getCurrentArmor(1).getItem().equals(ModItems.tribalLeggings)) {
    	if(player.getCurrentArmor(0) != null && player.getCurrentArmor(0).getItem().equals(ModItems.tribalBoots)) {
    		if(player.getCurrentArmor(2) != null && player.getCurrentArmor(2).getItem().equals(ModItems.tribalChest)) {
    			if(player.getCurrentArmor(3) != null && player.getCurrentArmor(3).getItem().equals(ModItems.tribalHelmet)) {
