...
public class ItemSkullArmor extends ItemHexArmor {
	
	public String textureName;
	
	public ItemSkullArmor(String unlocalizedName, ArmorMaterial material, int armorType, String name) {
...
//	}
   ...
   // @Override
    ...
    if (player.getCurrentArmor(1) != null && player.getCurrentArmor(1).getItem().equals(HG18Items.tribalLeggings)) {
    	if(player.getCurrentArmor(0) != null && player.getCurrentArmor(0).getItem().equals(HG18Items.tribalBoots)) {
    		if(player.getCurrentArmor(2) != null && player.getCurrentArmor(2).getItem().equals(HG18Items.tribalChest)) {
    			if(player.getCurrentArmor(3) != null && player.getCurrentArmor(3).getItem().equals(HG18Items.tribalHelmet)) {
